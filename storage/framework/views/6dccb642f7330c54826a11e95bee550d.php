...
<style>
    ...
    #button
    {
        background: url('<?php echo e(asset('img/add-user.svg')); ?>') no-repeat 120px center;
    ...
    @media(max-width: 700px)
    {
        #button 
        {
            background: url('<?php echo e(asset('img/add-user.svg')); ?>') no-repeat 50px center;
            background-color: #4caf50;
            color: #000;
            padding: 15px;
            border: none;
...
<body>
    ...
    <div class="container">
        <form id="contactForm" method="post" action="<?php echo e(route('naltis_contacts.ajouter')); ?>">
            <?php echo csrf_field(); ?> 
            <?php echo method_field('put'); ?>  
                <div>
                    <label for="nom"><img width="13" height="13" src="<?php echo e(asset('img/user-solid.svg')); ?>" alt=""/> Nom:</label>
                        <input type="text" id="nom" name="nom" placeholder="Nom " required>
                </div>

                <div>
                    <label for="prenom"><img width="13" height="13" src="<?php echo e(asset('img/user-solid.svg')); ?>" alt=""/> Prenom:</label>
...
// 
                ...
                <div>
                    <form method="post" action="<?php echo e(route('naltis_contacts.ajouter')); ?>">
                        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\naltis_contacts\resources\views/naltis_contacts/index.blade.php ENDPATH**/ ?>